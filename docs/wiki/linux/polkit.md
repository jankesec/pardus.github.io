...
![auth_admin_keep example](img/auth_admin_on_admin.png)

2. When `auth_admin` action runs on **Non Administrative User**:

![auth_admin_keep example](img/auth_admin_on_other_user.png)

3. When `auth_self` action runs on **Non Administrative User**:

![auth_admin_keep example](img/auth_self_on_other_user.png)
